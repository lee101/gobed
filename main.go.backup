...
func main() {
fmt.Println("================================================================================")
fmt.Println("GO EMBEDDING DIAGNOSTIC - FIXED VERSION")
fmt.Println("================================================================================")

// Load embedding model
embedding, err := gobed.NewEmbeddingModel("model/production_embedding_model.onnx", "model/debug_tokens_go.json", false)
if err != nil {
...
fmt.Println("Testing fixed implementation (no padding to 512)...")
...
fmt.Println("Expected first embedding: [3.483, -2.513, 3.576, -0.724, 1.369] (norm: 76.993)")
fmt.Println("================================================================================")
}
